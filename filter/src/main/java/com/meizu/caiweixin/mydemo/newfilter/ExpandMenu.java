...
import com.meizu.caiweixin.mydemo.filter.menu.PinnedHeaderExpandableListView;

/**
 * Created by caiweixin on 5/12/15.
 */
public class ExpandMenu extends BaseMenuView implements PinnedHeaderExpandableListView.OnHeaderUpdateListener,
    ...
    protected void initContentView() {
        mView = LayoutInflater.from(mContext).inflate(R.layout.filter_menu_expand, null);
        listView = (PinnedHeaderExpandableListView) mView.findViewById(R.id.filter_menu_expand);
